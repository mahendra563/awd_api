...
class ProjectController extends AdminController
{
    ...
    public function actionReportLowBalance($from, $to){
       ...
       (
        ...
        INNER JOIN `work_entries`  on `project_costs`.`cost_id`  = `work_entries`.`cost_id` 
    ...
    public function actionListManagers(){
        ...
        . " INNER JOIN employee_roles_joins ON employees.emp_id = employee_roles_joins.emp_id "
        . " WHERE employee_roles_joins.role_id = 2 AND project_managers.proj_id = :proj_id";
        
        if($proj_id == 0){
            $sql = "SELECT employees.* FROM employees "            
            . " INNER JOIN employee_roles_joins ON employees.emp_id = employee_roles_joins.emp_id "
            . " WHERE employee_roles_joins.role_id = 2";
        }*/
